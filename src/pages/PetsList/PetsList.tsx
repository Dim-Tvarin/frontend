  ...
  return (
    <div className="container 2xl:overflow-hidden">
      <div className="relative flex justify-center mt-30 lg:mt-100 mb-[120px] lg:mb-50">
        ...
        {data && (
          <div
            className={`md:top-100 lg:top-0 absolute flex justify-between m-0 w-full ${isFilterApplied ? 'top-100' : 'top-72'}`}
          >
            <CustomButton
              type="button"
      ...
      {isLoading ? (
        ...
        <div className="relative flex justify-around gap-20">
          {openFilters && (
            <div
              className={cn(
                'z-50 fixed xl:relative inset-0 flex flex-col items-start gap-24 bg-black/50 xl:bg-transparent p-0 xl:w-1/4 xl:h-fit',
                'animate-in fade-in-0 slide-in-from-left-64 duration-700 ease-out'
              )}
              onClick={() => {
