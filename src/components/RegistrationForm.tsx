...
const RegistrationForm: React.FC = () => {
  ...
  return (
    <div className=" flex flex-col px-16 sm:w-full 2xl:max-w-[630px]">
      <h1 className="text-default-btn mb-[16px] text-[18px] 2xl:mb-[41px] 2xl:text-[32px]">
        Реєстрація акаунту
      </h1>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="flex flex-col text-left gap-16 2xl:gap-32"
      >
        <InputField
          label="Ім’я або назва організації"
          placeholder="Введіть ваше імʼя"
          className="h-40 w-full 2xl:w-[630px]"
          labelClass="text-default-btn mb-10 2xl:mb-16"
          labelSize="base"
          id="name"
          {...register('name')}
        ...
        />
        <div className="flex gap-20 flex-col 2xl:flex-row">
          <div className="flex flex-col text-[16px]">
            <label
              htmlFor="location"
              className="text-base text-left text-default-btn leading-[125%] mb-10 2xl:mb-16"
            >
              Місто
            </label>
            <Controller
              ...
              render={({ field }) => (
                <CitySelect
                  ...
                  className="h-40 text-[16px] hover:border-input-border w-full 2xl:w-[305px]"
          ...
          <PhoneInput
            ...
            placeholder="+380"
            className="h-40 w-full 2xl:w-[305px]"
            labelClass="text-default-btn mb-10 2xl:mb-16"
            labelSize="base"
            id="phone"
            {...register('phone')}
        ...
        <CustomRadioGroup
          ...
          labelSize="base"
          labelClass="text-default-btn mb-10 2xl:mb-16"
          className="text-[16px] text-default-btn flex-col gap-10 sm:flex-row sm:gap-20"
          itemWidth="w-full"
        ...
        <PasswordField
          ...
          className="h-40 w-fulll 2xl:w-[630px]"
          labelClass="leading-[125%] text-default-btn mb-10 2xl:mb-[16px]"
          labelSize="base"
          id="password"
          {...register('password')}
        ...
        <PasswordField
          ...
          className="h-40 w-full 2xl:w-[630px]"
          labelClass="leading-[125%] text-default-btn mb-10 2xl:mb-16"
          labelSize="base"
          id="repeat_password"
        ...
        <CustomButton
          ...
          className="text-[16px] mt-4 2xl:mt-50"
        >
          Зареєструватися
        </CustomButton>
      </form>
