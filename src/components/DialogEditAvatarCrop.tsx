  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={() => dispatch(closeDialog())}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white dark:bg-dialog p-32 rounded-[30px] w-full lg:w-[754px] max-h-[661px]">
