...
const AnimalCard = ({name, gender, age, photoSrc}: {name: string; gender: string; age: animalAge; photoSrc: string;}) => {
  return (
    <div className="relative w-[305px] h-[400px] border-2 border-orange rounded-4xl max-w-sm bg-white overflow-hidden flex items-end">
      ...
      <div className="bg-main-pink-l/80 relative rounded-t-4xl z-10 w-full px-32 py-12 mb-50">
